...
class HuskyLensLibrary:
        ...
        if(inProduction):
            try:
                ...
                if(commandSplit[3] == "2e"):
                    ...
                    print("Number of Blocks or Arrows:", numberOfBlocksOrArrow)  # Adicionando a impressão
                    ...
                    for i in range(numberOfBlocksOrArrow):
                        ...
                        print("Length of returnData:", len(returnData))  # Adicionando a impressão
    ...
    def blocks(self):
        ...
        self.writeToHuskyLens(cmd)
        return self.processReturnData()[0] if self.processReturnData() else []
